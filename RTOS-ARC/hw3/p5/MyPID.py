...
class MyPID(object):
    """
    MyPID implements a PID controller for autonomous driving.
    This agent respects traffic lights and other vehicles, but ignores stop signs.
    It has several functions available to specify the route that the agent must follow,
    as well as to change its parameters in case a different driving mode is desired.
    """

    def __init__(self, vehicle, pidVars = {}, target_speed=20, opt_dict={}, map_inst=None, grp_inst=None):
        """
        Initialization the agent paramters, the local and the global planner.

            :param vehicle: actor to apply to agent logic onto
            :param pidVars: dictionary containing PID variables (Kp, Ki, Kd)
        ...
        # We don't need to follow speed limits
