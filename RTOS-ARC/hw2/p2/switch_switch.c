...
void switch_switch_step(_boolean press,_boolean *mode,_integer *x,switch_switch_ctx_type* ctx){   _integer _split_12;
   _integer _split_11;
   _boolean _split_10;
   _boolean _split_9;
   _boolean _split_8;
  ...
  Lustre_pre_2_get(&_split_2,&ctx->Lustre_pre_2_ctx_tab[0]); 
  Lustre_arrow_2_step(0,_split_2,&x_prev,&ctx->Lustre_arrow_2_ctx_tab[0]); 
  _split_5 = x_prev >= 10;
  ...
  Lustre_arrow_step(_false,_split_1,&mode_prev,&ctx->Lustre_arrow_ctx_tab[0]); 
  _split_3 = ! mode_prev;
   if (press == _true) {
     _split_4 = _true;
   } else {
  ...
  Lustre_pre_2_set(*x,&ctx->Lustre_pre_2_ctx_tab[0]); 
